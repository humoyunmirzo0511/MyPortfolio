                ...
                <div class="grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-[30px] grid gap-x-10 gap-y-7 mb-6">
                    ...
                    <div
                        ...
                        <h3
                            ...
                            <a href="blogTwo.html#ex1" rel="modal:open">How to Own Your Audience by Creating an Email
                                List.</a>
                        </h3>
                    </div>
                    <!-- blog items one end -->
                    ...
                    <div
                        ...
                        <div class="overflow-hidden rounded-lg">
                            <a href="blogTwo.html#ex2" rel="modal:open">
                                <img class="rounded-lg w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110"
                                     src="{{asset('portfolio/images/blog_images/small/2.jpg')}}" alt="blog image" />
                            </a>
                        </div>
                        <div class="flex mt-4 text-tiny text-gray-lite dark:text-[#A6A6A6]">
                            <span>10 April</span>
                        ...
                        <h3
                            class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                            <a href="blogTwo.html#ex2" rel="modal:open"> Everything You Need to Know About Web
                                Accessibility. </a>
                        </h3>
                    </div>
                    <!-- blog items two end  -->
                    ...
                    <div
                        ...
                        <div class="overflow-hidden rounded-lg">
                            <a href="blogTwo.html#ex3" rel="modal:open">
                                <img class="rounded-lg w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110"
                                     src="{{asset('portfolio/images/blog_images/small/3.jpg')}}" alt="blog image" />
                            </a>
                        </div>
                        <div class="flex mt-4 text-tiny text-gray-lite dark:text-[#A6A6A6]">
                            <span>21 April</span>
                        ...
                        <h3
                            class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                            <a href="blogTwo.html#ex3" rel="modal:open">he window know to say beside you</a>T
                        </h3>
                    </div>
                    ...
                    <div
                        ...
                        <div class="overflow-hidden rounded-lg">
                            <a href="blogTwo.html#ex4" rel="modal:open">
                                <img class="rounded-lg w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110"
                                     src="{{asset('portfolio/images/blog_images/small/4.jpg')}}" alt="blog image" />
                            </a>
                        </div>
                        <div class="flex mt-4 text-tiny text-gray-lite dark:text-[#A6A6A6]">
                            <span>27 April</span>
                        ...
                        <h3
                            class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                            <a href="blogTwo.html#ex4" rel="modal:open">Top 10 Toolkits for Deep Learning in 2021.</a>
                        </h3>
                    </div>
                    <!-- blog items four  end -->
                    ...
                    <div
                        class="p-5 rounded-lg mb-2 h-full dark:border-[#212425] bg-[#fcf4ff] dark:bg-transparent dark:border-2">
                        <div class="overflow-hidden rounded-lg">
                            <a href="blogTwo.html#ex5" rel="modal:open">
                                <img class="rounded-lg w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110"
                                     src="{{asset('portfolio/images/blog_images/small/5.jpg')}}" alt="blog image" />
                            </a>
                        </div>
                        <div class="flex mt-4 text-tiny text-gray-lite dark:text-[#A6A6A6]">
                            <span>27 April</span>
                        ...
                        <h3
                            class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                            <a href="blogTwo.html#ex5" rel="modal:open">How to Own Your Audience by Creating an Email
                                List.</a>
                        </h3>
                    </div>
                    <!-- blog items five   end -->
                    ...
                    <div
                        class="p-5 rounded-lg mb-2 h-full dark:border-[#212425] bg-[#fcf4ff] dark:bg-transparent dark:border-2">
                        <div class="overflow-hidden rounded-lg">
                            <a href="blogTwo.html#ex6" rel="modal:open">
                                <img class="rounded-lg w-full cursor-pointer transition duration-200 ease-in-out transform hover:scale-110"
                                     src="{{asset('portfolio/images/blog_images/small/6.jpg')}}" alt="blog image" />
                            </a>
                        </div>
                        <div class="flex mt-4 text-tiny text-gray-lite dark:text-[#A6A6A6]">
                            <span>27 April</span>
                        ...
                        <h3
                            class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                            <a href="blogTwo.html#ex6" rel="modal:open">Everything You Need to Know About Web
                                Accessibility.</a>
                        </h3>
                    </div>
                    <!-- blog items six  end -->
...
{{--        <!-- footer ends -->--}}
    ...
    <div id="ex1" class="modal-container modal">
        <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
            <div class="pr-3 pb-2">
                <img class="w-full md:h-[450px] object-cover rounded-xl mt-6" src="{{asset('portfolio/images/blog_images/1.jpg')}}"
                     alt="blog image" />
            ...
            <div class="rounded-lg mt-6 bg-gradient-to-r from-[#FA5252] to-[#DD2476] p-[1px] mr-3">
                <div class="dark:bg-[#232220] bg-[#ffffff] flex p-4 rounded-lg">
                    <div>
                        <img class="md:w-[125px] rounded-xl" src="{{asset('portfolio/images/about/about.jpg')}}" alt="about image" />
                    </div>
                    <div class="pl-5">
        ...
        <a href="blogTwo.html#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark ">Close</a>
        <a href="blogTwo.html#close-modal" rel="modal:close" class="close bg-close-light dark:bg-close-dark ">Close</a>
    </div>
    ...
    <div id="ex2" class="modal-container modal">
        <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
            <div class="pr-3 pb-2">
                <img class="w-full md:h-[450px] object-cover rounded-xl mt-6" src="{{asset('portfolio/images/blog_images/2.jpg')}}"
                     alt="blog image" />
                <div class="flex mt-4 text-tiny text-black dark:text-white">
                    <span>10 April</span>
                    <span class="dot-icon">Inspiration</span>
    ...
    <div id="ex3" class="modal-container modal">
        <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
            <div class="pr-3 pb-2">
                <img class="w-full md:h-[450px] object-cover rounded-xl mt-6" src="{{asset('portfolio/images/blog_images/3.jpg')}}"
                     alt="blog image" />
                <div class="flex mt-4 text-tiny text-black dark:text-white">
                    <span>07 April</span>
                    <span class="dot-icon">Inspiration</span>
    ...
    <div id="ex4" class="modal-container modal">
        <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
            <div class="pr-3 pb-2">
                <img class="w-full md:h-[450px] object-cover rounded-xl mt-6" src="{{asset('portfolio/images/blog_images/4.jpg')}}"
                     alt="blog image" />
                <div class="flex mt-4 text-tiny text-black dark:text-white">
                    <span>177 April</span>
                    <span class="dot-icon">Inspiration</span>
    ...
    <div id="ex5" class="modal-container modal">
        <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
            <div class="pr-3 pb-2">
                <img class="w-full md:h-[450px] object-cover rounded-xl mt-6" src="{{asset('portfolio/images/blog_images/5.jpg')}}"
                     alt="blog image" />
                <div class="flex mt-4 text-tiny text-black dark:text-white">
                    <span>177 April</span>
                    <span class="dot-icon">Inspiration</span>
    ...
    <div id="ex6" class="modal-container modal">
        <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
            <div class="pr-3 pb-2">
                <img class="w-full md:h-[450px] object-cover rounded-xl mt-6" src="{{asset('portfolio/images/blog_images/6.jpg')}}"
                     alt="blog image" />
                <div class="flex mt-4 text-tiny text-black dark:text-white">
                    <span>177 April</span>
                    <span class="dot-icon">Inspiration</span>
