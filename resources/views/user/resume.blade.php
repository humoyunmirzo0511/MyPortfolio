                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-6 gap-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <span class="text-tiny text-gray-lite dark:text-[#b7b7b7]">2019 - 2020</span>
                                <h3 class="text-xl dark:text-white"> Graphic Design </h3>
                                <p class="dark:text-[#b7b7b7]"> Jesus Ramirez's Photoshop course </p>
                            </div>
                            ...
                            <div
                                ...
                                <h3 class="text-xl dark:text-white"> Frontend Development </h3>
                                <p class="dark:text-[#b7b7b7]"> Web King education centre</p>
                            </div>
                            ...
                            <div
                                ...
                                <h3 class="text-xl dark:text-white">Backend Developer</h3>
                                <p class="dark:text-[#b7b7b7]"> Web King education centre </p>
                            </div>
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <span class="text-tiny text-gray-lite dark:text-[#b7b7b7]">2020 - 2021</span>
                                <h3 class="text-xl dark:text-white"> Graphic Designer </h3>
                                <p class="dark:text-[#b7b7b7]"> Frilansus team </p>
                            </div>

                            <div
                                class="py-4 dark:bg-transparent bg-[#f2f4ff] pl-5 pr-3 space-y-2 rounded-lg mb-6 dark:border-[#212425] dark:border-2">
                                <span class="text-tiny text-gray-lite dark:text-[#b7b7b7]">2021 - precent</span>
                                <h3 class="text-xl dark:text-white"> Mentor </h3>
                                <p class="dark:text-[#b7b7b7]"> IT Park Uzbekistan</p>
                            </div>

                            <div
                                class="py-4 dark:bg-transparent bg-[#eef5fa] pl-5 pr-3 space-y-2 rounded-lg dark:border-[#212425] dark:border-2">
                                <span class="text-tiny text-gray-lite dark:text-[#b7b7b7]">2022 - precent</span>
                                <h3 class="text-xl dark:text-white"> Backend Developer </h3>
                                <p class="dark:text-[#b7b7b7]"> Web King Freelance Group </p>
                            </div>
                        </div>
            ...
            <div class="container bg-[#f8fbfb] dark:bg-[#0D0D0D] py-12 px-4 sm:px-5 md:px-10 lg:px-20">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="col-span-1">
                        ...
                        @php
                            $skills = \Illuminate\Support\Facades\DB::table('skills')->get();
                            $knowledges = \Illuminate\Support\Facades\DB::table('knowledges')->get();
                        ...
                        @foreach($skills as $skill)
                            <div class="mb-5">
                                <div class="flex justify-between mb-1">
                                    <span
                                        class=" font-semibold text-[#526377] dark:text-[#A6A6A6]">{{$skill->name}}</span>
                                    <span
                                        class=" font-semibold text-[#526377] dark:text-[#A6A6A6">{{$skill->percent}}%</span>
                                </div>
                                <div class="w-full bg-[#edf2f2] rounded-full h-1 dark:bg-[#1c1c1c]">
                                    <div class="bg-[#{{$colors[rand(0,3)]}}] h-1 rounded-full"
