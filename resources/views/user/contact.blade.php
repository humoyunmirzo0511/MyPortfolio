                        ...
                        <div class="w-full lg:w-[40%] xl:w-[30%] space-y-6">
                            <div
                                class="flex flex-wrap bg-[#fcf4ff] dark:bg-transparent p-[30px] dark:border-[#212425] dark:border-2 gap-2 rounded-xl">
                                            <span class="w-8 mt-2">
                                                <img src="{{asset('portfolio/images/contact/phone-call.png')}}"
                                                     alt="icon"
                                                     class="text-4xl dark:text-white"/>
                                            </span>
                                <div class="space-y-2">
                                    <p class="text-xl font-semibold dark:text-white"> Phone : </p>
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]"> +998 99 842 79 79 </p>
                            ...
                            <div
                                class="flex flex-wrap dark:bg-transparent bg-[#eefbff] p-[30px] dark:border-[#212425] dark:border-2 gap-2 rounded-xl">
                                            <span class="w-8 mt-2">
                                                <img src="{{asset('portfolio/images/contact/email.png')}}" alt="icon"
                                                     class="text-4xl dark:text-white"/>
                                            </span>
                                <div class="space-y-2">
                                    <p class="text-xl font-semibold dark:text-white"> Email :</p>
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]">humoyunmirzo1105@gmail.com
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                class="flex flex-wrap dark:bg-transparent bg-[#f2f4ff] p-[30px] dark:border-[#212425] dark:border-2 gap-2 rounded-xl">
                                            <span class="w-8 mt-2">
                                                <img src="{{asset('portfolio/images/contact/map.png')}}" alt="icon"
                                                     class="text-4xl dark:text-white"/>
                                            </span>
                                <div class="space-y-2">
                                    <p class="text-xl font-semibold dark:text-white"> Address : </p>
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]"> Andijan Uzbekistan
                                    </p>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="space-y-2">
                                    <p class="text-xl font-semibold dark:text-white"> Address : </p>
                                    <a class="text-gray-lite text-lg dark:text-[#A6A6A6]"> Andijan Uzbekistan
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-full mt-8 lg:mt-0 lg:w-[60%] xl:w-[70%]">
                            <div data-aos="fade"
                                ...
                                <h3 class="text-4xl">
                                    ...
                                    <br/>
                                    <span class="font-semibold dark:text-white">work or
                                                    partnerships.</span>
                                </h3>
